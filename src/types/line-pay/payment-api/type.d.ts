import { CaptureRequestConfig, CaptureResponseBody } from '../line-pay-api/capture';
import { CheckRegKeyRequestConfig, CheckRegKeyResponseBody } from '../line-pay-api/check-regkey';
import { CheckPaymentStatusRequestConfig, CheckPaymentStatusResponseBody } from '../line-pay-api/check-payment-status';
import { ConfirmRequestConfig, ConfirmResponseBody } from '../line-pay-api/confirm';
import { PayPreapprovedRequestConfig, PayPreapprovedResponseBody } from '../line-pay-api/pay-preapproved';
...
import { ExpireRegKeyRequestConfig, ExpireRegKeyResponseBody } from '../line-pay-api/expire-regkey';
...
export declare type LinePayApiClients = {
  ...
  checkPaymentStatus: ApiClientBuilder<CheckPaymentStatusRequestConfig, CheckPaymentStatusResponseBody>;
  checkRegKey: ApiClientBuilder<CheckRegKeyRequestConfig, CheckRegKeyResponseBody>;
  payPreapproved: ApiClientBuilder<PayPreapprovedRequestConfig, PayPreapprovedResponseBody>;
  expireRegKey: ApiClientBuilder<ExpireRegKeyRequestConfig, ExpireRegKeyResponseBody>;
};
 ...
 */
export declare type ResponseBody<T extends keyof LinePayApiClients> = Awaited<
...
export declare type ApiHandler<T extends keyof LinePayApiClients> = (
