...
export declare type LineMerchantConfig = {
    /**
...
export declare type HttpResponse<R> = {
    /**
     * HTTP response body
     */
    data: R;
...
export declare type GeneralRequestConfig = {
    /**
     * API timeout
     */
    timeout?: number;
};
export declare type GeneralResponseBody = {
    /**
     * Return code
     */
    returnCode: string;
...
export declare type HttpConfig<Params = Record<string, string>> = {
    /**
...
export interface HttpClient {
     ...
     */
    post: <T, R>(url: string, body: T, config?: HttpConfig) => Promise<HttpResponse<R>>;
}
 ...
 */
export declare type Currency = 'USD' | 'JPY' | 'TWD' | 'THB';
